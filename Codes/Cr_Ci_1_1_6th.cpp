...
using namespace std; //Not applicable for certain style guides
...
int main()
{
    std::vector<string> words = {"abcde","hello","apple","padle"};

    for(auto word:words)
    {
        // std::boolalpha shows the values as true or false instead of 1 or 0
